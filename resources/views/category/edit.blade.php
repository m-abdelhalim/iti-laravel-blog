    ...
    <main class="container p-3">
        ...
        <div class="px-4 pt-5 my-5 text-center">
            <div class="col-lg-6 mx-auto">
                <form method="post" action="{{route('category.saveChanges', $category->id)}}">
                    @method('PUT')
                    @csrf
                    <div class="form-group d-flex">
                        <label class="w-25" for="name">category name:</label>
                        <input type="text" class="form-control" name="name" id="name" value="{{$category->name}}" aria-describedby="nameHelp" placeholder="Enter name">
